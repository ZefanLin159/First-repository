...
public class MergeSortedArray88 {
    ...
    // 归并排序的子序列函数，这个更好理解，不过需要多O(N)的空间复杂度
    public void merge1(int[] nums1, int m, int[] nums2, int n) {
        ...
        for (temp = 0; temp < m + n; temp++) {
            nums1[temp] = nums3[temp];
        }
    }
    ...
    public static void main(String[] args) {
        ...
        int[] nums2 = {4, 5, 6};
        mergeSortedArray88.merge1(nums1, nums1.length - nums2.length, nums2, nums2.length);
